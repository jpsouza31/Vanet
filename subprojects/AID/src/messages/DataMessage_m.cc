...
::omnetpp::simtime_t DataMessage::getMessageOriginTime() const
{
    return this->messageOriginTime;
}

void DataMessage::setMessageOriginTime(::omnetpp::simtime_t messageOriginTime)
{
    this->messageOriginTime = messageOriginTime;
}

::omnetpp::simtime_t DataMessage::getMessageTTL() const
{
    return this->messageTTL;
}

void DataMessage::setMessageTTL(::omnetpp::simtime_t messageTTL)
{
...
std::string DataMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return simtime2string(pp->getMessageOriginTime());
        case 3: return simtime2string(pp->getMessageTTL());
...
bool DataMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setMessageOriginTime(string2simtime(value)); return true;
        case 3: pp->setMessageTTL(string2simtime(value)); return true;
